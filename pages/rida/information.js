...
export default function InformationPrices({ heroes, pricepages, pageInfo }) {
  ...
  const [activeInfo, setActiveInfo] = useState("Fakturainfo");
  useEffect(() => {}, [activeInfo]);
  useEffect(() => {
    setActivePage("Information & Priser");
  }, []);
                  ...
                  return (
                    <div
                      ...
                      dangerouslySetInnerHTML={createMarkup(
                        item.information.infoDescriptionSection
                      )}
                    />
                  );
                }
